...
const TreeItem = ({ label, tree, nextUrl, urlSearch }: any) => {
  ...
  return (
    <div className={open ? "open" : "closed"} style={{ position: "relative" }}>
      ...
      {open && renderTree(tree, nextUrl, urlSearch)}
    </div>
  );
};

const renderTree = (tree: any, currentUrl: string, urlSearch: string) =>
