...
exceptions1.hospital = "hospital";
exceptions1.hospitals = "hospital";
...
exceptions1.mean = "meaning";
exceptions1.meant = "meaning";
exceptions1.meaneth = "meaning";
...
const isException = (word: string, stem: string) =>
  ((word === stem &&
    stem.length > 6 &&
 ...
 * @private
 */
var markRegions = function (s: string) {
 ...
 * @private
 */
var step2 = function (s: string) {
  var i,
    imax,
    rgn = markRegions(s),
    us; // updated s.
  var match: any = s.match(rgxSFXstep2);
 ...
 * @private
 */
var step3 = function (s: string) {
  var i,
    imax,
    rgn = markRegions(s),
    us; // updated s.
  var match: any = s.match(rgxSFXstep3);
  match = match === null ? "$$$$$" : match[1];
 ...
 * @private
 */
var step4 = function (s: string) {
  var rgn = markRegions(s);
  var match: any = s.match(rgxSFXstep4Full);
  match = match === null ? "$$$$$" : match[1];
...
const stem = function (w: string): string {
  ...
  if (!word.includes("‑")) {
    ...
    if (word.startsWith("meaning")) return "meaning";
